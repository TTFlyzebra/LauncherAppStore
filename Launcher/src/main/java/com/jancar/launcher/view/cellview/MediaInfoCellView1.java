...
public class MediaInfoCellView1 extends FrameLayout implements ICellView, View.OnClickListener {
    ...
    private View mViewMusic, mViewFm,wg_radio_title;
    private TextView fmTv01, fmTv02, fmTv03;
    private ImageView fmNext, fmPrev, musicPrev, musicNext, musicPlay;
    private TextView musicTv01;
    private ImageView musicId3img,fmimg;

    public MediaInfoCellView1(Context context) {
        this(context, null);
    }

    public MediaInfoCellView1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MediaInfoCellView1(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void initView(Context context) {
        ...
        View view = inflate(context, R.layout.wg_media_widget1, this);
        mViewMusic = view.findViewById(R.id.wg_music);
        mViewFm = view.findViewById(R.id.wg_radio);
        wg_radio_title = view.findViewById(R.id.wg_radio_title);
    ...
    private void upWidgetView() {
        switch (mLastSession) {
            case Page.PAGE_FM:
                ...
                wg_radio_title.setVisibility(View.VISIBLE);
            ...
            case Page.PAGE_MUSIC:
                ...
                wg_radio_title.setVisibility(View.GONE);
                //更新标题
                ...
                if (mBitmap == null) {
                    musicId3img.setImageResource(Page.PAGE_MUSIC.equals(mLastSession) ?
                            R.drawable.mediainfo_music_default1 : R.drawable.mediainfo_bt_default1);
                } else {
