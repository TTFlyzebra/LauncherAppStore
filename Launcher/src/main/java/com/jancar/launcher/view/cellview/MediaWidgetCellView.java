...
public class MediaWidgetCellView extends FrameLayout implements ICellView{
    private CellBean appInfo;
    private FlyImageView imageView;
    private MirrorView mirrorView;

    public MediaWidgetCellView(Context context) {
        this(context, null);
    }

    public MediaWidgetCellView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MediaWidgetCellView(Context context, AttributeSet attrs, int defStyleAttr) {
